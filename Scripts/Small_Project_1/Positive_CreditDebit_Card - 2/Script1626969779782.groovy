...
for (def rowlogin = 1; rowlogin <= data.getRowNumbers(); rowlogin++) {
    ...
    WebUI.click(findTestObject('Small_Project_1/Credit_Debit_Payment/checklistbox_potongan_10rp_cc'))
    ...
    WebUI.switchToFrame(findTestObject('Small_Project_1/Credit_Debit_Payment/lbl_iframe_issuing_bank'), 15)
