...
WebUI.verifyElementText(findTestObject('Manual/OrangeHRM/verify_panel_username'), 'Welcome Paul')

WebUI.click(findTestObject('Manual/OrangeHRM/verify_panel_username'))

WebUI.verifyElementVisible(findTestObject('Manual/OrangeHRM/Panel_User'))
